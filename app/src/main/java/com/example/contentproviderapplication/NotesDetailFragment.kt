...
import com.example.contentproviderapplication.database.NoteProvider.Companion.URI_NOTES
import com.example.contentproviderapplication.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.example.contentproviderapplication.database.NotesDatabaseHelper.Companion.TITLE_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEditDescription = view.findViewById(R.id.note_edit_description) as EditText
